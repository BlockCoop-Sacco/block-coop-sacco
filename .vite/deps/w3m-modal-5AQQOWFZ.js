...
var W3mModalBase = class extends LitElement {
  ...
  async onNewAddress(caipAddress) {
    ...
    const isNextAuthenticated = caipAddress && SIWXUtil.getSIWX() ? sessions.some((session) => {
      var _a;
      return session.data.accountAddress === ((_a = ParseUtil.parseCaipAddress(caipAddress)) == null ? void 0 : _a.address);
    }) : true;
...
//# sourceMappingURL=w3m-modal-5AQQOWFZ.js.map
