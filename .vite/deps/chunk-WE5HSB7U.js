import {
  ConnectorUtil,
  WalletUtil
} from "./chunk-UZMN552P.js";
import {
  W3mFrameHelpers,
  W3mFrameProvider
} from "./chunk-GTWEFYSC.js";
import {
  CaipNetworksUtil,
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-C3TBNQAF.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-476TF6KL.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-VX3DGUEF.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-KQ4BHRP5.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-DLNHF3PQ.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-XBYUY7RQ.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-6GDAXKSD.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-DC4KMI3S.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-TOKUSQ6O.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-IQPUULCW.js"),
      import("./w3m-modal-5AQQOWFZ.js")
    ]);
  }
};

// node_modules/@reown/appkit/dist/esm/exports/constants.js
var PACKAGE_VERSION = "1.7.12";
...
//# sourceMappingURL=chunk-WE5HSB7U.js.map
