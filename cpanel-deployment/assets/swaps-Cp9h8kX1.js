import{q as P,r as C,D,Z as _,x as u,v as K,F as W,R as S,A as j,z as V,M,G as F,W as Q,w as q,J as G}from"./index-JnDdLfGv.js";import{r as s,n as h,c as E,U as m}from"./if-defined-BvD-dsaf.js";import"./index-Dcv7hB9j.js";import{M as L}from"./index-BY1S3-vS.js";import"./index-DONXf2ey.js";import{S as n}from"./index-BtTYno7Y.js";import"./index-DWo465I2.js";import"./index-CuOKs5Si.js";import"./index-CwgC9Isa.js";import"./index-VgyyatP8.js";import"./index-BZ8L8zwL.js";import"./ref-BA0Uz3_C.js";const H={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",R=r==="x",U=i===",",O=i===".",B=i>="0"&&i<="9";!a&&(l||x||v||R)&&c.preventDefault(),t==="0"&&!U&&!O&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(U||O)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!O&&!U&&c.preventDefault()}},Z=P`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,o){var a=arguments.length,i=a<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(i=(a<3?r(i):a>3?r(t,e,i):r(t,e))||i);return a>3&&i&&Object.defineProperty(t,e,i),i};let N=class extends C{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};N.styles=[X];z([h()],N.prototype,"target",void 0);N=z([E("w3m-swap-input-skeleton")],N);const Y=P`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
