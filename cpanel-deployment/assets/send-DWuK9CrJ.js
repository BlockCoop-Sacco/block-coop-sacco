import{q as f,r as w,z as I,D as x,N as H,_ as l,x as u,w as z,J as W,R as g,Z as L,$ as q,H as B,F,G as M,W as Y}from"./index-JnDdLfGv.js";import{n as d,r as c,c as m,U as b,o as G}from"./if-defined-BvD-dsaf.js";import"./index-Dcv7hB9j.js";import"./index-BZ8L8zwL.js";import{e as O,n as D}from"./ref-BA0Uz3_C.js";import{n as J,s as K}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-vJiGPCki.js";import{S as Z}from"./index-BtTYno7Y.js";import"./index-CuOKs5Si.js";import"./index-DHi1aXem.js";import"./index-Cl0G-vlB.js";import"./index-CwgC9Isa.js";import"./index-VgyyatP8.js";const Q=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var j=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var a=o.length-1;a>=0;a--)(s=o[a])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let A=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var e;return(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
      ${D(this.inputElementRef)}
      type="text"
      inputmode="decimal"
      pattern="[0-9,.]*"
    ...
    /> `}dispatchInputChangeEvent(e){var n,r;const i=e.data;if(i&&((n=this.inputElementRef)!=null&&n.value))if(i===","){const t=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=t,this.value=`${this.value}${t}`}else J.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(K,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:(r=this.inputElementRef.value)==null?void 0:r.value,bubbles:!0,composed:!0}))}};A.styles=[z,W,X];j([d({type:Boolean})],A.prototype,"disabled",void 0);j([d({type:String})],A.prototype,"value",void 0);j([d({type:String})],A.prototype,"placeholder",void 0);A=j([m("wui-input-amount")],A);const ee=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
