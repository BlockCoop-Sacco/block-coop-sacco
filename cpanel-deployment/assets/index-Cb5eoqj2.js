import{q as _,r as N,x as a,w as Y,D as C,aa as h,z as I,R as L,O as z,F as E,G as F,W}from"./index-JnDdLfGv.js";import{n as l,c as S,o as k,r as v}from"./if-defined-BvD-dsaf.js";import{T as A,D as U}from"./index-DI9FdF6x.js";import"./index-BZ8L8zwL.js";import"./index-vJiGPCki.js";import"./index-CwgC9Isa.js";var R;(function(o){o.approve="approved",o.bought="bought",o.borrow="borrowed",o.burn="burnt",o.cancel="canceled",o.claim="claimed",o.deploy="deployed",o.deposit="deposited",o.execute="executed",o.mint="minted",o.receive="received",o.repay="repaid",o.send="sent",o.sell="sold",o.stake="staked",o.trade="swapped",o.unstake="unstaked",o.withdraw="withdrawn"})(R||(R={}));const V=_`
  :host > wui-flex {
    display: flex;
...
`;var x=function(o,t,e,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,e):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(o,t,e,r);else for(var c=o.length-1;c>=0;c--)(n=o[c])&&(i=(s<3?n(i):s>3?n(t,e,i):n(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i};const D="last-transaction",P=7;let f=class extends N{constructor(){super(),this.unsubscribe=[],this.paginationObserver=void 0,this.page="activity",this.caipAddress=C.state.activeCaipAddress,this.transactionsByYear=h.state.transactionsByYear,this.loading=h.state.loading,this.empty=h.state.empty,this.next=h.state.next,h.clearCursor(),this.unsubscribe.push(C.subscribeKey("activeCaipAddress",t=>{t&&this.caipAddress!==t&&(h.resetTransactions(),h.fetchTransactions(t)),this.caipAddress=t}),C.subscribeKey("activeCaipNetwork",()=>{this.updateTransactionView()}),h.subscribe(t=>{this.transactionsByYear=t.transactionsByYear,this.loading=t.loading,this.empty=t.empty,this.next=t.next}))}firstUpdated(){this.updateTransactionView(),this.createPaginationObserver()}updated(){this.setPaginationObserver()}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return a` ${this.empty?null:this.templateTransactionsByYear()}
    ...
    ${!this.loading&&this.empty?this.templateEmpty():null}`}updateTransactionView(){h.resetTransactions(),this.caipAddress&&h.fetchTransactions(I.getPlainAddress(this.caipAddress))}templateTransactionsByYear(){return Object.keys(this.transactionsByYear).sort().reverse().map(e=>{const r=parseInt(e,10),s=new Array(12).fill(null).map((i,n)=>{var u;const c=A.getTransactionGroupTitle(r,n),d=(u=this.transactionsByYear[r])==null?void 0:u[n];return{groupTitle:c,transactions:d}}).filter(({transactions:i})=>i).reverse();return s.map(({groupTitle:i,transactions:n},c)=>{const d=c===s.length-1;return n?a`
          <wui-flex
        ...
        `:null})})}templateRenderTransaction(t,e){const{date:r,descriptions:s,direction:i,isAllNFT:n,images:c,status:d,transfers:u,type:y}=this.getTransactionListItemProps(t),b=(u==null?void 0:u.length)>1;return(u==null?void 0:u.length)===2&&!n?a`
    ...
    </wui-flex>`}templateEmpty(){return this.page==="account"?a`${this.emptyStateAccount()}`:a`${this.emptyStateActivity()}`}templateLoading(){return this.page==="activity"?Array(P).fill(a` <wui-transaction-list-item-loader></wui-transaction-list-item-loader> `).map(t=>t):null}onReceiveClick(){L.push("WalletReceive")}createPaginationObserver(){const t=C.state.activeChain,{projectId:e}=z.state;this.paginationObserver=new IntersectionObserver(([r])=>{r!=null&&r.isIntersecting&&!this.loading&&(h.fetchTransactions(I.getPlainAddress(this.caipAddress)),E.sendEvent({type:"track",event:"LOAD_MORE_TRANSACTIONS",properties:{address:I.getPlainAddress(this.caipAddress),projectId:e,cursor:this.next,isSmartAccount:F(t)===W.ACCOUNT_TYPES.SMART_ACCOUNT}}))},{}),this.setPaginationObserver()}setPaginationObserver(){var e,r,s;(e=this.paginationObserver)==null||e.disconnect();const t=(r=this.shadowRoot)==null?void 0:r.querySelector(`#${D}`);t&&((s=this.paginationObserver)==null||s.observe(t))}getTransactionListItemProps(t){var d,u,y,b,O;const e=U.formatDate((d=t==null?void 0:t.metadata)==null?void 0:d.minedAt),r=A.getTransactionDescriptions(t),s=t==null?void 0:t.transfers,i=(u=t==null?void 0:t.transfers)==null?void 0:u[0],n=!!i&&((y=t==null?void 0:t.transfers)==null?void 0:y.every($=>!!$.nft_info)),c=A.getTransactionImages(s);return{date:e,direction:i==null?void 0:i.direction,descriptions:r,isAllNFT:n,images:c,status:(b=t.metadata)==null?void 0:b.status,transfers:s,type:(O=t.metadata)==null?void 0:O.operationType}}};f.styles=M;x([l()],f.prototype,"page",void 0);x([v()],f.prototype,"caipAddress",void 0);x([v()],f.prototype,"transactionsByYear",void 0);x([v()],f.prototype,"loading",void 0);x([v()],f.prototype,"empty",void 0);x([v()],f.prototype,"next",void 0);f=x([S("w3m-activity-list")],f);
